...
export class theverge extends BasePage{     
    navBar: By = By.css('.flex items-end font-light'); 
    ...
    homebutton: By = By.css('.h-[28px] w-[117px] hover:opacity-60 hover:transition-all hover:ease-in-out md:translate-y-2 fill-white"]');
